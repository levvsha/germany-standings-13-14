...
export function createTeamBlank(teamName) {
  return {
    name: teamName,
    played: 0,
    won: 0,
...
export function processingTournamentData(state, stats) {
...
export function calculateStandings(numLastRound, tournamentData) {
  const teams = {};
...
export function recalculateStandings(state, round, tournamentData) {
...
export function calculateResultsOfTeam(state, targetTeamName) {
